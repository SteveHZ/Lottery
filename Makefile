# This Makefile is for the Lottery extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Lottery]
#     EXE_FILES => [q[script/lottery_cgi.pl], q[script/lottery_create.pl], q[script/lottery_fastcgi.pl], q[script/lottery_server.pl], q[script/lottery_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[Lottery]
#     NO_META => q[1]
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/lottery_cgi.pl \
	script/lottery_create.pl \
	script/lottery_fastcgi.pl \
	script/lottery_server.pl \
	script/lottery_test.pl
MAN3PODS = lib/Lottery.pm \
	lib/Lottery/Controller/Root.pm
...
TO_INST_PM = lib/Lottery.pm \
	lib/Lottery/Controller/Root.pm

PM_TO_BLIB = lib/Lottery.pm \
	blib\lib\Lottery.pm \
	lib/Lottery/Controller/Root.pm \
	blib\lib\Lottery\Controller\Root.pm
...
Lottery.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Lottery\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	lib/Lottery.pm \
	lib/Lottery/Controller/Root.pm \
	script/lottery_cgi.pl \
	script/lottery_create.pl \
	script/lottery_fastcgi.pl \
	script/lottery_server.pl \
	script/lottery_test.pl
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) -u \
	  script/lottery_cgi.pl $(INST_MAN1DIR)\lottery_cgi.pl.$(MAN1EXT) \
	  script/lottery_create.pl $(INST_MAN1DIR)\lottery_create.pl.$(MAN1EXT) \
	  script/lottery_fastcgi.pl $(INST_MAN1DIR)\lottery_fastcgi.pl.$(MAN1EXT) \
	  script/lottery_server.pl $(INST_MAN1DIR)\lottery_server.pl.$(MAN1EXT) \
	  script/lottery_test.pl $(INST_MAN1DIR)\lottery_test.pl.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Lottery.pm $(INST_MAN3DIR)\Lottery.$(MAN3EXT) \
	  lib/Lottery/Controller/Root.pm $(INST_MAN3DIR)\Lottery.Controller.Root.$(MAN3EXT) 
...
EXE_FILES = script/lottery_cgi.pl script/lottery_create.pl script/lottery_fastcgi.pl script/lottery_server.pl script/lottery_test.pl

pure_all :: $(INST_SCRIPT)\lottery_server.pl $(INST_SCRIPT)\lottery_test.pl $(INST_SCRIPT)\lottery_cgi.pl $(INST_SCRIPT)\lottery_fastcgi.pl $(INST_SCRIPT)\lottery_create.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)\lottery_server.pl $(INST_SCRIPT)\lottery_test.pl \
	  $(INST_SCRIPT)\lottery_cgi.pl $(INST_SCRIPT)\lottery_fastcgi.pl \
	  $(INST_SCRIPT)\lottery_create.pl 

$(INST_SCRIPT)\lottery_server.pl : script/lottery_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\lottery_server.pl
	$(CP) script/lottery_server.pl $(INST_SCRIPT)\lottery_server.pl
	$(FIXIN) $(INST_SCRIPT)\lottery_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\lottery_server.pl

$(INST_SCRIPT)\lottery_test.pl : script/lottery_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\lottery_test.pl
	$(CP) script/lottery_test.pl $(INST_SCRIPT)\lottery_test.pl
	$(FIXIN) $(INST_SCRIPT)\lottery_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\lottery_test.pl

$(INST_SCRIPT)\lottery_cgi.pl : script/lottery_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\lottery_cgi.pl
	$(CP) script/lottery_cgi.pl $(INST_SCRIPT)\lottery_cgi.pl
	$(FIXIN) $(INST_SCRIPT)\lottery_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\lottery_cgi.pl

$(INST_SCRIPT)\lottery_fastcgi.pl : script/lottery_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\lottery_fastcgi.pl
	$(CP) script/lottery_fastcgi.pl $(INST_SCRIPT)\lottery_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)\lottery_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\lottery_fastcgi.pl

$(INST_SCRIPT)\lottery_create.pl : script/lottery_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\lottery_create.pl
	$(CP) script/lottery_create.pl $(INST_SCRIPT)\lottery_create.pl
	$(FIXIN) $(INST_SCRIPT)\lottery_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\lottery_create.pl
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Lottery.pm blib\lib\Lottery.pm \
	  lib/Lottery/Controller/Root.pm blib\lib\Lottery\Controller\Root.pm 
